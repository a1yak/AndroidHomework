...
public final class FragmentHw2Binding implements ViewBinding {
  ...
  private FragmentHw2Binding(@NonNull FrameLayout rootView, @NonNull Button btnStarthw2,
      @NonNull Button btnStarthw2cat, @NonNull EditText etNumber, @NonNull FrameLayout frgHw2,
      @NonNull TextView introRange, @NonNull TextView tvRangeOfNumber,
  ...
  public static FragmentHw2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHw2Binding((FrameLayout) rootView, btnStarthw2, btnStarthw2cat, etNumber,
          frgHw2, introRange, tvRangeOfNumber, tvSummOfNumbers, tvSummOfValues);
    }
